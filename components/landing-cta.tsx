...
export function CTAButton({ href, variant, ctaName, ctaLocation, children, isSignUp }: CTAButtonProps) {
  ...
  const baseClasses = variant === "final"
    ...
    : variant === "primary"
      ? "px-8 py-4 bg-mango-red text-white border-2 border-mango-dark font-bold text-2xl uppercase shadow-[6px_6px_0px_#000] hover:scale-105 hover:-rotate-2 transition-all"
      : "px-8 py-4 bg-white text-mango-dark border-2 border-mango-dark font-bold text-2xl uppercase shadow-[6px_6px_0px_#000] hover:scale-105 hover:-rotate-2 transition-all"
